...
struct gengetopt_args_info
{
  ...
  char * conf_file_arg;	/**< @brief If set, the simulator will read the configuration from this file.  */
  char * conf_file_orig;	/**< @brief If set, the simulator will read the configuration from this file original value given at command line.  */
  const char *conf_file_help; /**< @brief If set, the simulator will read the configuration from this file help description.  */
