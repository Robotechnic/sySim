/*
  ...
  /usr/bin/gengetopt --input=/home/robotechnic/Documents/c++ projet/sySim/src/sySim.ggo
  --file-name=argparse --output-dir=/home/robotechnic/Documents/c++ projet/sySim/src/argparse
...
const char *gengetopt_args_info_description =
    "This program simulates a communication channel between two programs.\nIt allows to test "
    "communication protocols and simulate packet loss and\ncorruption.";
...
const char *gengetopt_args_info_help[] = {
    ...
    "               (default=off)",
    "\nMessage checking:",
    "  -k, --check               If set, the simulator will check that the payloads\n              "
    "                are received in the correct order  (default=off)",
    "  -f, --continueOnFailure   If set, the simulator will continue even if the\n                 "
...
typedef enum { ARG_NO, ARG_FLAG, ARG_STRING, ARG_INT, ARG_FLOAT } cmdline_parser_arg_type;
...
static void clear_given(struct gengetopt_args_info *args_info) {
    ...
    args_info->continueOnFailure_given = 0;
...
static void clear_args(struct gengetopt_args_info *args_info) {
    ...
    args_info->continueOnFailure_flag = 0;
...
static void init_args_info(struct gengetopt_args_info *args_info) {
    ...
    args_info->continueOnFailure_help = gengetopt_args_info_help[17];
...
int cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info) {
    ...
    if (args_info->continueOnFailure_given)
        write_into_file(outfile, "continueOnFailure", 0, 0);
...
int cmdline_parser_internal(int argc, char **argv, struct gengetopt_args_info *args_info,
    ...
    while (1) {
        ...
        static struct option long_options[] = {{"help", 0, NULL, 'h'},
                                               ...
                                               {"color", 0, NULL, 'C'},
                                               {"check", 0, NULL, 'k'},
                                               {"continueOnFailure", 0, NULL, 'f'},
                                               {"visualize", 1, NULL, 'v'},
                                               {0, 0, 0, 0}};

        c = getopt_long(argc, argv, "hVm:l:c:d:t:s:bL:qCkfv:", long_options, &option_index);
        ...
        switch (c) {
            ...
            case 'm': /* Number of messages to send.  */
                ...
                if (update_arg((void *)&(args_info->messages_arg), &(args_info->messages_orig),
                               &(args_info->messages_given), &(local_args_info.messages_given),
                               optarg, 0, "10", ARG_INT, check_ambiguity, override, 0, 0,
                               "messages", 'm', additional_error))
                    goto failure;

                break;
            case 'l': /* Packet loss probability.  */

                if (update_arg((void *)&(args_info->loss_arg), &(args_info->loss_orig),
                               &(args_info->loss_given), &(local_args_info.loss_given), optarg, 0,
                               "0.0", ARG_FLOAT, check_ambiguity, override, 0, 0, "loss", 'l',
                               additional_error))
                    goto failure;
            ...
            case 'c': /* Packet corruption probability.  */
                ...
                if (update_arg((void *)&(args_info->corruption_arg), &(args_info->corruption_orig),
                               &(args_info->corruption_given), &(local_args_info.corruption_given),
                               optarg, 0, "0.0", ARG_FLOAT, check_ambiguity, override, 0, 0,
                               "corruption", 'c', additional_error))
                    goto failure;

                break;
            case 'd': /* Average delay between packets.  */

                if (update_arg((void *)&(args_info->delay_arg), &(args_info->delay_orig),
                               &(args_info->delay_given), &(local_args_info.delay_given), optarg, 0,
                               "20.0", ARG_FLOAT, check_ambiguity, override, 0, 0, "delay", 'd',
                               additional_error))
                    goto failure;
            ...
            case 't': /* Maximum time to run the simulation.  */
                ...
                if (update_arg((void *)&(args_info->maxTime_arg), &(args_info->maxTime_orig),
                               &(args_info->maxTime_given), &(local_args_info.maxTime_given),
                               optarg, 0, "100.0", ARG_FLOAT, check_ambiguity, override, 0, 0,
                               "maxTime", 't', additional_error))
                    goto failure;

                break;
            case 's': /* Seed for the random number generator.  */

                if (update_arg((void *)&(args_info->seed_arg), &(args_info->seed_orig),
                               &(args_info->seed_given), &(local_args_info.seed_given), optarg, 0,
                               "42", ARG_INT, check_ambiguity, override, 0, 0, "seed", 's',
                               additional_error))
                    goto failure;
            ...
            case 'b': /* If set, the channel will be bidirectional.  */
                ...
                if (update_arg((void *)&(args_info->bidirectional_flag), 0,
                               &(args_info->bidirectional_given),
            ...
            case 'L': /* Logging level.  */
                ...
                if (update_arg((void *)&(args_info->loglevel_arg), &(args_info->loglevel_orig),
                               &(args_info->loglevel_given), &(local_args_info.loglevel_given),
                               optarg, 0, "2", ARG_INT, check_ambiguity, override, 0, 0, "loglevel",
                               'L', additional_error))
                    goto failure;
            ...
            case 'q': /* If set, the program won't print anything to stdout.  */
                ...
                if (update_arg((void *)&(args_info->quiet_flag), 0, &(args_info->quiet_given),
                               ...
                               check_ambiguity, override, 1, 0, "quiet", 'q', additional_error))
                    goto failure;
            ...
            case 'C': /* If set, the program will use colors in the output.  */
                ...
                if (update_arg((void *)&(args_info->color_flag), 0, &(args_info->color_given),
                               ...
                               check_ambiguity, override, 1, 0, "color", 'C', additional_error))
                    goto failure;

                break;
            case 'k': /* If set, the simulator will check that the payloads are received in the
                         correct order.  */

                if (update_arg((void *)&(args_info->check_flag), 0, &(args_info->check_given),
                               &(local_args_info.check_given), optarg, 0, 0, ARG_FLAG,
                               check_ambiguity, override, 1, 0, "check", 'k', additional_error))
                    goto failure;

                break;
            case 'f': /* If set, the simulator will continue even if the messages are not received
                         in the correct order.  */

                if (update_arg((void *)&(args_info->continueOnFailure_flag), 0,
                               &(args_info->continueOnFailure_given),
                               &(local_args_info.continueOnFailure_given), optarg, 0, 0, ARG_FLAG,
                               check_ambiguity, override, 1, 0, "continueOnFailure", 'f',
                               additional_error))
                    goto failure;

                break;
            case 'v': /* If set, the simulator will export an svg file with the visualization of the
                         simulation.  */

                if (update_arg((void *)&(args_info->visualize_arg), &(args_info->visualize_orig),
                               &(args_info->visualize_given), &(local_args_info.visualize_given),
                               optarg, 0, 0, ARG_STRING, check_ambiguity, override, 0, 0,
                               "visualize", 'v', additional_error))
                    goto failure;
            ...
            case 0: /* Long option with no short option */
                ...
                if (strcmp(long_options[option_index].name, "logfile") == 0) {
                    ...
                    if (update_arg((void *)&(args_info->logfile_arg), &(args_info->logfile_orig),
                                   &(args_info->logfile_given), &(local_args_info.logfile_given),
                                   optarg, 0, 0, ARG_STRING, check_ambiguity, override, 0, 0,
                                   "logfile", '-', additional_error))
                        goto failure;
                }
