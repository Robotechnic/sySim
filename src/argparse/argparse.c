...
int cmdline_parser_internal(int argc, char **argv, struct gengetopt_args_info *args_info,
    ...
    while (1) {
        ...
        static struct option long_options[] = {
            ...
            {"messages", 1, NULL, 'm'},      {"loss", 1, NULL, 'l'},
            {"corruption", 1, NULL, 'c'},    {"delay", 1, NULL, 'd'},
            {"maxTime", 1, NULL, 't'},       {"seed", 1, NULL, 's'},
            {"bidirectional", 0, NULL, 'b'}, {"loglevel", 1, NULL, 'L'},
            {"logfile", 1, NULL, 0},         {"quiet", 0, NULL, 'q'},
            {"color", 0, NULL, 'C'},         {0, 0, 0, 0}};
