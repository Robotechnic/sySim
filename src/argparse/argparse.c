/*
  ...
  /usr/bin/gengetopt --input=/home/robotechnic/Documents/c++ projet/sySym/src/sySym.ggo
  --file-name=argparse --output-dir=/home/robotechnic/Documents/c++ projet/sySym/src/argparse
...
const char *gengetopt_args_info_usage = "Usage: sySym [OPTION]...";
...
const char *gengetopt_args_info_help[] = {
    ...
    "  -d, --delay=FLOAT       Average delay between packets  (default=`0.0')",
...
typedef enum { ARG_NO, ARG_STRING, ARG_INT, ARG_FLOAT } cmdline_parser_arg_type;
...
int cmdline_parser_internal(int argc, char **argv, struct gengetopt_args_info *args_info,
    ...
    while (1) {
        ...
        static struct option long_options[] = {
            ...
            {"seed", 1, NULL, 's'},       {"loglevel", 1, NULL, 'L'},
            {"logfile", 1, NULL, 0},      {0, 0, 0, 0}};

        c = getopt_long(argc, argv, "hVm:l:c:d:s:L:", long_options, &option_index);
        ...
        switch (c) {
            ...
            case 'd': /* Average delay between packets.  */
                ...
                if (update_arg((void *)&(args_info->delay_arg), &(args_info->delay_orig),
                               ...
                               "0.0", ARG_FLOAT, check_ambiguity, override, 0, 0, "delay", 'd',
                               additional_error))
                    goto failure;
            ...
            case 'L': /* Logging level.  */
                ...
                if (update_arg((void *)&(args_info->loglevel_arg), &(args_info->loglevel_orig),
                               ...
                               optarg, 0, "0", ARG_INT, check_ambiguity, override, 0, 0, "loglevel",
                               'L', additional_error))
                    goto failure;
