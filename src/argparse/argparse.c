/*
  ...
  /usr/bin/gengetopt --conf-parser --input=/home/robotechnic/Documents/c++
  projet/sySim/src/sySim.ggo --file-name=argparse --output-dir=/home/robotechnic/Documents/c++
  projet/sySim/src/argparse
        ...
        switch (c) {
            ...
            case 'd': /* Average delay between packets.  */
                ...
                if (update_arg((void *)&(args_info->delay_arg), &(args_info->delay_orig),
                               ...
                               "5.0", ARG_FLOAT, check_ambiguity, override, 0, 0, "delay", 'd',
                               additional_error))
                    goto failure;
            ...
            case 't': /* Maximum time to run the simulation.  */
                ...
                if (update_arg((void *)&(args_info->maxTime_arg), &(args_info->maxTime_orig),
                               ...
                               optarg, 0, "200.0", ARG_FLOAT, check_ambiguity, override, 0, 0,
            ...
            case 'k': /* If set, the program will use colors in the output.  */
                ...
                if (update_arg((void *)&(args_info->color_flag), 0, &(args_info->color_given),
                               ...
                               check_ambiguity, override, 1, 0, "color", 'k', additional_error))
                    goto failure;
            ...
            case 'f': /* If set, the simulator will continue even if the messages are not received
                ...
                if (update_arg((void *)&(args_info->stop_on_failure_flag), 0,
                               &(args_info->stop_on_failure_given),
            ...
            case 'C': /* If set, the simulator will read the configuration from this file.  */
                ...
                if (update_arg((void *)&(args_info->conf_file_arg), &(args_info->conf_file_orig),
                               &(args_info->conf_file_given), &(local_args_info.conf_file_given),
                               optarg, 0, 0, ARG_STRING, check_ambiguity, override, 0, 0,
                               "conf-file", 'C', additional_error))
                    goto failure;
            ...
            case 0: /* Long option with no short option */
                ...
                /* If set, the simulator will check that the payloads are received in the correct
                   order.  */
                    ...
                    if (update_arg((void *)&(args_info->check_flag), 0, &(args_info->check_given),
                                   ...
                                   check_ambiguity, override, 1, 0, "check", '-', additional_error))
                        goto failure;
                }
